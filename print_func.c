#include "main.h"
/**
 * print_func - returns amt of indentifiers
 * @s: arg indetifier
 * @index: index of arg identifier
 * Return:amt of identifier
 */
int print_func(const char *s, int index)
{
	print_t pr[] = {
		...
		{"Id", prinlint}, {"lu", prinlunt}, {"lo", prinloct},
